                    ...
                    <div class="col-lg-6 col-lg-offset-3">
                        ...
                        <div class="form-group">
                            <label class="sd">SD</label>
                                <input type="text" name="sd" class="form-control" size="50" value="<?=$data['sd']?>" required>
                        </div>
                        <div class="form-group">
                            <label class="sltp">SLTP</label>
                                <input type="text" name="sltp" class="form-control" size="50" value="<?=$data['sltp']?>" required>
                        </div>
                        <div class="form-group">
                            <label class="slta">SMA / SMK</label>
                                <input type="text" name="slta" class="form-control" size="50" value="<?=$data['slta']?>" required>
                        </div>
                        <div class="form-group">
                            <label class="slta">Jurusan SMA / SMK</label>
                                <input type="text" name="sltaJur" class="form-control" size="50" value="<?=$data['sltaJur']?>"required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="d1">Jurusan D1</label>
                                <input type="text" name="d1Jur" class="form-control" size="50" value="<?=$data['sltaJur']?>"required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="d2">Jurusan D2</label>
                                <input type="text" name="d2Jur" class="form-control" size="50" value="<?=$data['d2Jur']?>"required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="d3">Jurusan D3</label>
                                <input type="text" name="d3Jur" class="form-control" size="50" value="<?=$data['d3Jur']?>"required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="s1">Jurusan s1</label>
                                <input type="text" name="s1Jur" class="form-control" size="50" value="<?=$data['s1Jur']?>"required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="s2">Jurusan s2</label>
                                <input type="text" name="s2Jur" class="form-control" size="50" value="<?=$data['s2Jur']?>"required>
                        </div>
                        <div class="form-group">
